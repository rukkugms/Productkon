...
-(void)Userrighttickselect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<Userrighttickselect xmlns=\"http://test.kontract360.com/\">\n"
                   "<UserId>%d</UserId>\n"
   ...
   //  NSURL *url = [NSURL URLWithString:@"http://test.kontract360.com/service.asmx"];
    ...
    [theRequest addValue: @"http://test.kontract360.com/Userrighttickselect" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
...
-(void)Userrightsuboftickselect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<Userrightsuboftickselect xmlns=\"http://test.kontract360.com/\">\n"
                   "<UserId>%d</UserId>\n"
                    "<subof>%d</subof>\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/Userrightsuboftickselect" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
...
-(void)Userrightsubofmastertickselect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<Userrightsubofmastertickselect xmlns=\"http://test.kontract360.com/\">\n"
                   "<UserId>%d</UserId>\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/Userrightsubofmastertickselect" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
...
-(void)Userrightmoduletickselect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<Userrightmoduletickselect xmlns=\"http://test.kontract360.com/\">\n"
                   "<UserId>%d</UserId>\n"
                   "<ModuleId>%d</ModuleId>\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/Userrightmoduletickselect" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
