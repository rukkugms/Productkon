...
-(void)SiteRequirementlistselect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SiteRequirementlistselect xmlns=\"https://vip.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/SiteRequirementlistselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)SiteRequirementlist2select{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SiteRequirementlist2select xmlns=\"https://vip.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/SiteRequirementlist2select" forHTTPHeaderField:@"Soapaction"];
...
//    NSString*jobid=[NSString stringWithFormat:@"%@-%@",[array1 objectAtIndex:0],[array1 objectAtIndex:1]];
  NSString *soapMessage;
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SiteRequirementlistInsert xmlns=\"https://vip.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/SiteRequirementlistInsert" forHTTPHeaderField:@"Soapaction"];
...
-(void)SiterequirementlistDelete{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SiterequirementlistDelete xmlns=\"https://vip.kontract360.com/\">\n"
                    "<JSRID>%d</JSRID>\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/SiterequirementlistDelete" forHTTPHeaderField:@"Soapaction"];
