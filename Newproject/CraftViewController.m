...
-(void)CraftBasicRequirementsselect
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<CraftBasicRequirementsselect xmlns=\"https://vip.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/CraftBasicRequirementsselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)CraftBasicrequirementsinsert
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<CraftBasicrequirementsinsert xmlns=\"https://vip.kontract360.com/\">\n"
                   "<BRRequirementId>%d</BRRequirementId>\n"
                   "<BRValue>%d</BRValue>\n"
   ...
   //   NSURL *url = [NSURL URLWithString:@"http://192.168.0.1/service.asmx"];
    ...
    [theRequest addValue: @"https://vip.kontract360.com/CraftBasicrequirementsinsert" forHTTPHeaderField:@"Soapaction"];
...
-(void)Multicraftselect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<Multicraftselect xmlns=\"https://vip.kontract360.com/\">\n"
                    "<BRRequirementId>%d</BRRequirementId>\n"
                   "</Multicraftselect>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",_reqid];
   ...
   //   NSURL *url = [NSURL URLWithString:@"http://192.168.0.1/service.asmx"];
    ...
    [theRequest addValue: @"https://vip.kontract360.com/Multicraftselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)CraftrequirementDelete{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<CraftrequirementDelete xmlns=\"https://vip.kontract360.com/\">\n"
                     "<BRRequirementId>%d</BRRequirementId>\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/CraftrequirementDelete" forHTTPHeaderField:@"Soapaction"];
