...
-(void)SelectAllOther{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SelectAllOther xmlns=\"https://testUSA.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/SelectAllOther" forHTTPHeaderField:@"Soapaction"];
...
-(void)SelectAllSubtypeOther{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SelectAllSubtypeOther xmlns=\"https://testUSA.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/SelectAllSubtypeOther" forHTTPHeaderField:@"Soapaction"];
...
-(void)InsertOther{
   ...
   // NSString*unitcost=[_unitcsttxtfld.text stringByReplacingOccurrencesOfString:@"$" withString:@""];
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<InsertOther xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<ItemCode>%@</ItemCode>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/InsertOther" forHTTPHeaderField:@"Soapaction"];
...
//     NSString*YearlyRate=_yearlytxtfld.text;
  ...
  Equpmntmdl*eqmdl=(Equpmntmdl *)[_Assetarray objectAtIndex:path];
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<UpdateOther xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<ItemCode>%@</ItemCode>\n"
                   "<Description>%@</Description>\n"
                   "<PurchaseValue>%f</PurchaseValue>\n"
                   "<SerialNo>%@</SerialNo>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/UpdateOther" forHTTPHeaderField:@"Soapaction"];
...
-(void)DeleteOther{
  ...
  Equpmntmdl*eqmdl=(Equpmntmdl *)[_Assetarray objectAtIndex:deltepath];
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<DeleteOther xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<entryid>%d</entryid>\n"
                   "</DeleteOther>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",eqmdl.entryid];
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/DeleteOther" forHTTPHeaderField:@"Soapaction"];
...
-(void)SearchOther{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SearchOther xmlns=\"https://testUSA.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/SearchOther" forHTTPHeaderField:@"Soapaction"];
