...
-(void)ProjectManPowerRequiredSelect
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<ProjectManPowerRequiredSelect xmlns=\"https://vip.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/ProjectManPowerRequiredSelect" forHTTPHeaderField:@"Soapaction"];
...
-(void)LabourDescriptionSelect
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<LabourDescriptionSelect xmlns=\"https://vip.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/LabourDescriptionSelect" forHTTPHeaderField:@"Soapaction"];
...
-(void)LabourCalenderdateSelect
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<LabourCalenderdateSelect xmlns=\"https://vip.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/LabourCalenderdateSelect" forHTTPHeaderField:@"Soapaction"];
...
-(void)ManPowerJobnumberSelect
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<ManPowerJobnumberSelect xmlns=\"https://vip.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/ManPowerJobnumberSelect" forHTTPHeaderField:@"Soapaction"];
...
-(void)ManpowerreqSearch
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<ManpowerreqSearch xmlns=\"https://vip.kontract360.com/\">\n"
                   "<string1>%@</string1>\n"
                   "<string2>%@</string2>\n"
                   "<string3>%@</string3>\n"
                   "<cnt>%d</cnt>\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/ManpowerreqSearch" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
...
-(void)CountFromEmployeeSelect
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<CountFromEmployeeSelect xmlns=\"https://vip.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/CountFromEmployeeSelect" forHTTPHeaderField:@"Soapaction"];
