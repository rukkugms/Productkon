...
-(void)SelectAllPlans
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SelectAllPlans xmlns=\"https://vip.kontract360.com/\">\n"
 ...
 //   NSURL *url = [NSURL URLWithString:@"https://vip.kontract360.com/service.asmx"];
    ...
    [theRequest addValue: @"https://vip.kontract360.com/SelectAllPlans" forHTTPHeaderField:@"Soapaction"];
...
-(void)SelectAllLeads{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SelectAllLeads xmlns=\"https://vip.kontract360.com/\">\n"
  ...
  //  NSURL *url = [NSURL URLWithString:@"https://vip.kontract360.com/service.asmx"];
    ...
    [theRequest addValue: @"https://vip.kontract360.com/SelectAllLeads" forHTTPHeaderField:@"Soapaction"];
...
-(void)insertplans
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<InsertPlan xmlns=\"https://vip.kontract360.com/\">\n"
...
//NSURL *url = [NSURL URLWithString:@"testUSA.kontract360.com/service.asmx"];
 //   NSURL *url = [NSURL URLWithString:@"https://vip.kontract360.com/service.asmx"];
    ...
    [theRequest addValue: @"https://vip.kontract360.com/InsertPlan" forHTTPHeaderField:@"Soapaction"];
...
-(void)CreateFolderforPlan
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<CreateFolderforPlan xmlns=\"https://vip.kontract360.com/\">\n"
                   "<planid>%@</planid>\n"
                   "<customername>%@</customername>\n"
                   "<lead>%d</lead>\n"
                   "<customer>%d</customer>\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/CreateFolderforPlan" forHTTPHeaderField:@"Soapaction"];
...
-(void)UpdatePlan
{
   ...
   if([leadclicked isEqualToString:@"Clicked"])
   {
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<UpdatePlan xmlns=\"https://vip.kontract360.com/\">\n"
                   "<planid>%@</planid>\n"
                   "<customername>%@</customername>\n"
                   "<leadid>%d</leadid>\n"
                   "<cusid>%d</cusid>\n"
  ...
  //  NSURL *url = [NSURL URLWithString:@"https://vip.kontract360.com/service.asmx"];
    ...
    [theRequest addValue: @"https://vip.kontract360.com/UpdatePlan" forHTTPHeaderField:@"Soapaction"];
...
-(void)DeletePlan
{
   ...
   planmodel*plnmdl=(planmodel *)[_planlistarray objectAtIndex:path];
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<soap:Body>\n"
                   "<DeletePlan xmlns=\"https://vip.kontract360.com/\">\n"
                   "<planid>%@</planid>\n"
                   "</DeletePlan>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",plnmdl.planid];
  ...
  //  NSURL *url = [NSURL URLWithString:@"https://vip.kontract360.com/service.asmx"];
    ...
    [theRequest addValue: @"https://vip.kontract360.com/DeletePlan" forHTTPHeaderField:@"Soapaction"];
...
-(void)SearchPlan
{
   // webtype=1;
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<soap:Body>\n"
                   "<SearchPlan xmlns=\"https://vip.kontract360.com/\">\n"
  ...
  //  NSURL *url = [NSURL URLWithString:@"https://vip.kontract360.com/service.asmx"];
    ...
    [theRequest addValue: @"https://vip.kontract360.com/SearchPlan" forHTTPHeaderField:@"Soapaction"];
...
-(void)WorkTypecountSelect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<WorkTypecountSelect xmlns=\"https://vip.kontract360.com/\">\n"
                    "<PlanId>%@</PlanId>\n"
                   "</WorkTypecountSelect>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",plmdl.planid];
    ...
    [theRequest addValue: @"https://vip.kontract360.com/WorkTypecountSelect" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
...
-(void)CreateNewPlanFromExisting{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<CreateNewPlanFromExisting xmlns=\"https://vip.kontract360.com/\">\n"
                   "<plID>%@</plID>\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/CreateNewPlanFromExisting" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
