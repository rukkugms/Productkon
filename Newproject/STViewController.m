...
-(void)LeadstatusInsert{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<LeadstatusInsert xmlns=\"https://vip.kontract360.com/\">\n"
                   "<LSName>%@</LSName>\n"
                   "</LeadstatusInsert>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",_statustxtfld.text];
    ...
    [theRequest addValue: @"https://vip.kontract360.com/LeadstatusInsert" forHTTPHeaderField:@"Soapaction"];
...
-(void)LeadStatusUpdate{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<LeadStatusUpdate xmlns=\"https://vip.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/LeadStatusUpdate" forHTTPHeaderField:@"Soapaction"];
...
-(void)LeadStatusDelete{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<LeadStatusDelete xmlns=\"https://vip.kontract360.com/\">\n"
                   "<LSEntryId>%d</LSEntryId>\n"
                   "</LeadStatusDelete>\n"
                   "</soap:Body>\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/LeadStatusDelete" forHTTPHeaderField:@"Soapaction"];
