...
-(void)SelectAllPhases{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<Phasesbasedonworktypeselect xmlns=\"https://testUSA.kontract360.com/\">\n"
   ...
   //  NSURL *url = [NSURL URLWithString:@"https://testusa.kontract360.com/service.asmx"];
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/Phasesbasedonworktypeselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)GeneralcountSelect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<GeneralcountSelect xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<PlanId>%@</PlanId>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/GeneralcountSelect" forHTTPHeaderField:@"Soapaction"];
...
-(void)UnitSelect{
   p=@"Other";
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<UnitSelect xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<PlanId>%@</PlanId>\n"
                   "</UnitSelect>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",_Planid];
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/UnitSelect" forHTTPHeaderField:@"Soapaction"];
...
-(void)SubUnitSelect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SubUnitSelect xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<PlanId>%@</PlanId>\n"
                   "</SubUnitSelect>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",_Planid];
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/SubUnitSelect" forHTTPHeaderField:@"Soapaction"];
...
-(void)GeneralEquipmentSelect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<GeneralEquipmentSelect xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<PlanId>%@</PlanId>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/GeneralEquipmentSelect" forHTTPHeaderField:@"Soapaction"];
...
-(void)ProjectHeaderselect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<ProjectHeaderselect xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<PlanId>%@</PlanId>\n"
                   "</ProjectHeaderselect>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",_Planid];
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/ProjectHeaderselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)GeneralInsert{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<GeneralInsert xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<Unit>%@</Unit>\n"
                   "<SubUnit>%@</SubUnit>\n"
                   "<Equipment>%@</Equipment>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/GeneralInsert" forHTTPHeaderField:@"Soapaction"];
...
-(void)GeneralUpdates{
   ...
   _generalmdl=(Generalmodel *)[_generalarray objectAtIndex:0];
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<GeneralUpdates xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<Id>%d</Id>\n"
                   "<Unit>%@</Unit>\n"
                   "<SubUnit>%@</SubUnit>\n"
                   "<Equipment>%@</Equipment>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/GeneralUpdates" forHTTPHeaderField:@"Soapaction"];
...
//        if (value1==0) {
//            UIAlertView *alert1=[[UIAlertView alloc]initWithTitle:@"" message:@"Invalid Qunatity" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
//            [alert1 show];
//            
//        }}
