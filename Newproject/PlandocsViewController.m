...
-(void)PlanDocumentsSelect
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<PlanDocumentsSelect xmlns=\"https://vip.kontract360.com/\">\n"
                   "<PlanId>%@</PlanId>\n"
                   "</PlanDocumentsSelect>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",_planid];
    ...
    [theRequest addValue: @"https://vip.kontract360.com/PlanDocumentsSelect" forHTTPHeaderField:@"Soapaction"];
...
- (IBAction)viewbtn:(id)sender {
    ...
    NSString *fullURL =[NSString stringWithFormat:@"https://vip.kontract360.com%@",[_docmntdict objectForKey:[_documntarray objectAtIndex:textFieldIndexPath.row]]];
