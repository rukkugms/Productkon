...
-(void)PlanDocumentsSelect
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<PlanDocumentsSelect xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<PlanId>%@</PlanId>\n"
                   "</PlanDocumentsSelect>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",_planid];
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/PlanDocumentsSelect" forHTTPHeaderField:@"Soapaction"];
