...
-(void)VolumeDiscountselect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<VolumeDiscountselect xmlns=\"https://testUSA.kontract360.com/\">\n"
   ...
   //   NSURL *url = [NSURL URLWithString:@"https://testusa.kontract360.com/service.asmx"];
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/VolumeDiscountselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)SelectMarkupMaster{
   tabletype=2;
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SelectMarkupMaster xmlns=\"https://testUSA.kontract360.com/\">\n"
   ...
   //   NSURL *url = [NSURL URLWithString:@"https://testusa.kontract360.com/service.asmx"];
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/SelectMarkupMaster" forHTTPHeaderField:@"Soapaction"];
...
-(void)BaseWagesselect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<BaseWagesselect xmlns=\"https://testUSA.kontract360.com/\">\n"
                    "<ContractId>%d</ContractId>\n"
                    "<MarkUpId>%d</MarkUpId>\n"
                   "</BaseWagesselect>\n"
                   "</soap:Body>\n"
   ...
   //   NSURL *url = [NSURL URLWithString:@"https://testusa.kontract360.com/service.asmx"];
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/BaseWagesselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)ContractFuelesEquipmentselect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<ContractFuelesEquipmentselect xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<ContractId>%d</ContractId>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/ContractFuelesEquipmentselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)ContractNonFuelesEquipmentselect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<ContractNonFuelesEquipmentselect xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<ContractId>%d</ContractId>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/ContractNonFuelesEquipmentselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)ContractScaffoldRateselect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<ContractScaffoldRateselect xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<ContractId>%d</ContractId>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/ContractScaffoldRateselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)Equipmenttermscontractorselect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<Equipmenttermscontractorselect xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<ContractId>%d</ContractId>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/Equipmenttermscontractorselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)EquipmenttermsThirdPartyselect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<EquipmenttermsThirdPartyselect xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<ContractId>%d</ContractId>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/EquipmenttermsThirdPartyselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)ContractDoumentselect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<ContractDoumentselect xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<ContractId>%d</ContractId>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/ContractDoumentselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)DeliveryRateselect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<DeliveryRateselect xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<ContractId>%d</ContractId>\n"
                   "</DeliveryRateselect>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",_subcntrct.contractid];
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/DeliveryRateselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)Notescontractselect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<Notescontractselect xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<ContraId>%d</ContraId>\n"
                   "</Notescontractselect>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",_subcntrct.contractid];
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/Notescontractselect" forHTTPHeaderField:@"Soapaction"];
...
- (IBAction)viewbtn:(id)sender
{
    ...
    NSString *fullURL =[NSString stringWithFormat:@"https://testUSA.kontract360.com%@",[_documntdict objectForKey:[_documentarray objectAtIndex:textFieldIndexPath.row]]];
        //if (!self.webctrl) {
