...
-(void)Selectcrew{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<PlanCrewSelect xmlns=\"http://test.kontract360.com/\">\n"
   ...
   // NSURL *url = [NSURL URLWithString:@"http://test.kontract360.com/service.asmx"];
    ...
    [theRequest addValue: @"http://test.kontract360.com/PlanCrewSelect" forHTTPHeaderField:@"Soapaction"];
...
-(void)GeneralDetailselect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<GeneralDetailselect xmlns=\"http://test.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/GeneralDetailselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)ManHoursSelect
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<ManHoursSelect xmlns=\"http://test.kontract360.com/\">\n"
                   "<MainGeneralId>%d</MainGeneralId>\n"
                   "</ManHoursSelect>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",_generalid];
    ...
    [theRequest addValue: @"http://test.kontract360.com/ManHoursSelect" forHTTPHeaderField:@"Soapaction"];
...
-(void)GeneralDetailInsert{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<GeneralDetailInsert xmlns=\"http://test.kontract360.com/\">\n"
                   "<MainGeneralId>%d</MainGeneralId>\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/GeneralDetailInsert" forHTTPHeaderField:@"Soapaction"];
...
-(void)GeneralDetailDelete{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<GeneralDetailDelete xmlns=\"http://test.kontract360.com/\">\n"
                   "<Id>%d</Id>\n"
                   "</GeneralDetailDelete>\n"
                   "</soap:Body>\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/GeneralDetailDelete" forHTTPHeaderField:@"Soapaction"];
...
-(void)GeneralDetailUpdate{
  ...
  //  Manpwr*manmdl1=(Manpwr *)[_manpowerarray objectAtIndex:path];
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<GeneralDetailUpdate xmlns=\"http://test.kontract360.com/\">\n"
                   "<Id>%d</Id>\n"
                   "<MainGeneralId>%d</MainGeneralId>\n"
                   "<SubGeneralId>%d</SubGeneralId>\n"
                   "<Number>%d</Number>\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/GeneralDetailUpdate" forHTTPHeaderField:@"Soapaction"];
...
-(void)GeneralResourceMaterialDetailselect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<GeneralResourceMaterialDetailselect xmlns=\"http://test.kontract360.com/\">\n"
                   "<MainGeneralId>%d</MainGeneralId>\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/GeneralResourceMaterialDetailselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)GeneralResourceDetailInsert{
   ...
   // Metgenmdl *matmdl=(Metgenmdl*)[_resourcearray ob]
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<GeneralResourceDetailInsert xmlns=\"http://test.kontract360.com/\">\n"
                   "<MainGeneralId>%d</MainGeneralId>\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/GeneralResourceDetailInsert" forHTTPHeaderField:@"Soapaction"];
...
-(void)GeneralResourceDetailUpdate{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<GeneralResourceDetailUpdate xmlns=\"http://test.kontract360.com/\">\n"
                    "<Id>%d</Id>\n"
                   "<MainGeneralId>%d</MainGeneralId>\n"
                   "<SubGeneralCrewId>%d</SubGeneralCrewId>\n"
                   "<GroupDescription>%@</GroupDescription>\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/GeneralResourceDetailUpdate" forHTTPHeaderField:@"Soapaction"];
...
-(void)GeneralGroupDetailDelete{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<GeneralGroupDetailDelete xmlns=\"http://test.kontract360.com/\">\n"
                   "<Id>%d</Id>\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/GeneralGroupDetailDelete" forHTTPHeaderField:@"Soapaction"];
...
-(void)GeneralQuantityUpdate{
  //  Metgenmdl * matmdl2=(Metgenmdl *)[_resourcearray objectAtIndex:metdeletepath];
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<GeneralQuantityUpdate xmlns=\"http://test.kontract360.com/\">\n"
                    "<mainId>%d</mainId>\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/GeneralQuantityUpdate" forHTTPHeaderField:@"Soapaction"];
