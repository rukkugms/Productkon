...
-(void)SearchUsers
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SearchUsers xmlns=\"http://testUSA.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"http://testUSA.kontract360.com/SearchUsers" forHTTPHeaderField:@"Soapaction"];
...
-(void)PasswordForUser
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<PasswordForUser xmlns=\"http://testUSA.kontract360.com/\">\n"
                    "<UserName>%@</UserName>\n"
                   "</PasswordForUser>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",usrmdl.username];
    ...
    [theRequest addValue: @"http://testUSA.kontract360.com/PasswordForUser" forHTTPHeaderField:@"Soapaction"];
