...
-(void)EstimateSelect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<EstimateSelect xmlns=\"http://test.kontract360.com/\">\n"
   ...
   NSURL *url = [NSURL URLWithString:@"http://testusa.kontract360.com/service.asmx"];
    ...
    [theRequest addValue: @"http://test.kontract360.com/EstimateSelect" forHTTPHeaderField:@"Soapaction"];
...
-(void)EstimateInsert{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<EstimateInsert xmlns=\"http://test.kontract360.com/\">\n"
                   "<leadid>%d</leadid>\n"
                   "<CId>%d</CId>\n"
   ...
   NSURL *url = [NSURL URLWithString:@"http://testusa.kontract360.com/service.asmx"];
    ...
    [theRequest addValue: @"http://test.kontract360.com/EstimateInsert" forHTTPHeaderField:@"Soapaction"];
...
-(void)EstimationPlanSelect
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<EstimationPlanSelect xmlns=\"http://test.kontract360.com/\">\n"
   ...
   NSURL *url = [NSURL URLWithString:@"http://testusa.kontract360.com/service.asmx"];
    ...
    [theRequest addValue: @"http://test.kontract360.com/EstimationPlanSelect" forHTTPHeaderField:@"Soapaction"];
...
-(void)EstimationWorkTypeSelect
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<EstimationWorkTypeSelect xmlns=\"http://test.kontract360.com/\">\n"
                    "<planid>%@</planid>\n"
   ...
   NSURL *url = [NSURL URLWithString:@"http://testusa.kontract360.com/service.asmx"];
    ...
    [theRequest addValue: @"http://test.kontract360.com/EstimationWorkTypeSelect" forHTTPHeaderField:@"Soapaction"];
