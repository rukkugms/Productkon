...
-(void)EquipmentandOthersSelect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<EquipmentandOthersSelect xmlns=\"https://testUSA.kontract360.com/\">\n"
  ...
  //    NSURL *url = [NSURL URLWithString:@"https://testusa.kontract360.com/service.asmx"];
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/EquipmentandOthersSelect" forHTTPHeaderField:@"Soapaction"];
...
-(void)EquipmentJobNumberSelect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<EquipmentJobNumberSelect xmlns=\"https://testUSA.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/EquipmentJobNumberSelect" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
...
-(void)EquipmentItemNameSelect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<EquipmentItemNameSelect xmlns=\"https://testUSA.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/EquipmentItemNameSelect" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
...
-(void)EquipmentDateSelect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<EquipmentDateSelect xmlns=\"https://testUSA.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/EquipmentDateSelect" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
...
-(void)EQOthersSearch{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<EQOthersSearch xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<string1>%@</string1>\n"
                   "<string2>%@</string2>\n"
                   "<string3>%@</string3>\n"
                   "<cnt>%d</cnt>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/EQOthersSearch" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
...
- (IBAction)stockoutbtn:(id)sender {
   ...
   // }
//    else{
//    UIAlertView*alert=[[UIAlertView alloc]initWithTitle:@"" message:@"Process Completed" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil, nil]
//    ;
//    [alert show];
//
//
