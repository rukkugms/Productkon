...
-(void)TypeofLeadInsert{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<TypeofLeadInsert xmlns=\"http://test.kontract360.com/\">\n"
   ...
   NSURL *url = [NSURL URLWithString:@"http://test.kontract360.com/service.asmx"];
    ...
    [theRequest addValue: @"http://test.kontract360.com/TypeofLeadInsert" forHTTPHeaderField:@"Soapaction"];
...
-(void)TypeofLeadUpdate{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<TypeofLeadUpdate xmlns=\"http://test.kontract360.com/\">\n"
   ...
   NSURL *url = [NSURL URLWithString:@"http://test.kontract360.com/service.asmx"];
    ...
    [theRequest addValue: @"http://test.kontract360.com/TypeofLeadUpdate" forHTTPHeaderField:@"Soapaction"];
...
-(void)TypeofLeadstypeDelete{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<TypeofLeadstypeDelete xmlns=\"http://test.kontract360.com/\">\n"
                   "<TOLEntryId>%d</TOLEntryId>\n"
   ...
   NSURL *url = [NSURL URLWithString:@"http://test.kontract360.com/service.asmx"];
    ...
    [theRequest addValue: @"http://test.kontract360.com/TypeofLeadstypeDelete" forHTTPHeaderField:@"Soapaction"];
