...
@interface LdtypViewController ()

@end

@implementation LdtypViewController
...
- (IBAction)updatebtn:(id)sender
{
    if ([_leadtxtfld.text stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceCharacterSet]].length==0) {
        UIAlertView *alert=[[UIAlertView alloc]initWithTitle:@"" message:@"Lead Type is required" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
        [alert show];
        _leadtxtfld.text=@"";
    }
    else{
...
-(void)TypeofLeadInsert{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<TypeofLeadInsert xmlns=\"https://testUSA.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/TypeofLeadInsert" forHTTPHeaderField:@"Soapaction"];
...
-(void)TypeofLeadUpdate{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<TypeofLeadUpdate xmlns=\"https://testUSA.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/TypeofLeadUpdate" forHTTPHeaderField:@"Soapaction"];
...
-(void)TypeofLeadstypeDelete{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<TypeofLeadstypeDelete xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<TOLEntryId>%d</TOLEntryId>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/TypeofLeadstypeDelete" forHTTPHeaderField:@"Soapaction"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil) {
        ...
        if(tableView==_leadtypetable){
            ...
            [[NSBundle mainBundle]loadNibNamed:@"TPcell" owner:self options:nil];
            cell=_leadcell;
        }
