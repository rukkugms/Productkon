...
-(IBAction)addservicetotable:(id)sender
{
    ...
    {
        UIAlertView *alert=[[UIAlertView alloc]initWithTitle:@"" message:@"Select a Service" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
        [alert show];
    }
    else
    {
...
-(void)InsertPlanService{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<InsertPlanService xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<planid>%@</planid>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/InsertPlanService" forHTTPHeaderField:@"Soapaction"];
...
-(void)Planningdeleteplanservice{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<Planningdeleteplanservice xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<planid>%@</planid>\n"
                   "<serviceid>%d</serviceid>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/Planningdeleteplanservice" forHTTPHeaderField:@"Soapaction"];
...
-(void)SelectPlanServices{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SelectPlanServices xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<planid>%@</planid>"
                   "</SelectPlanServices>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",_planID];
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/SelectPlanServices" forHTTPHeaderField:@"Soapaction"];
