...
-(void)FetchApplicantId{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<FetchApplicantId xmlns=\"http://test.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/FetchApplicantId" forHTTPHeaderField:@"Soapaction"];
...
-(void)SelectVerificationcomment{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SelectVerificationcomment xmlns=\"http://test.kontract360.com/\">\n"
                   "<Applicant_Id>%d</Applicant_Id>\n"
                   "<Type>%@</Type>\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/SelectVerificationcomment" forHTTPHeaderField:@"Soapaction"];
...
//    }
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<InsertVerificationComments xmlns=\"http://test.kontract360.com/\">\n"
                   "<Applicant_Id>%d</Applicant_Id>\n"
                   "<user_Id>%d</user_Id>\n"
                   "<comment>%@</comment>\n"
                   "<type>%@</type>\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/InsertVerificationComments" forHTTPHeaderField:@"Soapaction"];
...
-(void)CustEmployeeselect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<CustEmployeeselect xmlns=\"http://test.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/CustEmployeeselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)EmployeeInsert{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<EmployeeInsert xmlns=\"http://test.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/EmployeeInsert" forHTTPHeaderField:@"Soapaction"];
