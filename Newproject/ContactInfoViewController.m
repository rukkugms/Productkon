...
-(void)CustomercontactInfoselect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<CustomercontactInfoselect xmlns=\"http://test.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/CustomercontactInfoselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)CustomerContactInfoInsert{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<CustomerContactInfoInsert xmlns=\"http://test.kontract360.com/\">\n"
                   "<CustomerCode>%@</CustomerCode>\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/CustomerContactInfoInsert" forHTTPHeaderField:@"Soapaction"];
...
-(void)CustomerContactInfoUpdate{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<CustomerContactInfoUpdate xmlns=\"http://test.kontract360.com/\">\n"
                   "<EntryId>%d</EntryId>\n"
                   "<CustomerCode>%@</CustomerCode>\n"
                   "<ContactName>%@</ContactName>\n"
                   "<ContactEmail>%@</ContactEmail>\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/CustomerContactInfoUpdate" forHTTPHeaderField:@"Soapaction"];
...
-(void)CustomerContactInfodelete{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<CustomerContactInfodelete xmlns=\"http://test.kontract360.com/\">\n"
                   "<EntryId>%d</EntryId>\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/CustomerContactInfodelete" forHTTPHeaderField:@"Soapaction"];
...
-(void)CustomerContactInfoSearch{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<CustomerContactInfoSearch xmlns=\"http://test.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/CustomerContactInfoSearch" forHTTPHeaderField:@"Soapaction"];
