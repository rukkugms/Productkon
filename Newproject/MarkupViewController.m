...
-(void)MarkupMain1select
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<MarkupMain1select xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<MarkupID>%d</MarkupID>\n"
                   "</MarkupMain1select>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",[markupid integerValue]];
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/MarkupMain1select" forHTTPHeaderField:@"Soapaction"];
