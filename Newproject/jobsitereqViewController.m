...
-(void)DeleteJobSites
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<DeleteJobSites xmlns=\"https://vip.kontract360.com/\">\n"
                   "<id>%d</id>\n"
                   "</DeleteJobSites>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",jbmdl.jobid];
    ...
    [theRequest addValue: @"https://vip.kontract360.com/DeleteJobSites" forHTTPHeaderField:@"Soapaction"];
...
-(void)InsertJobSites
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<InsertJobSites xmlns=\"https://vip.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/InsertJobSites" forHTTPHeaderField:@"Soapaction"];
...
{   webtype=1;
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<UpdateJobSites xmlns=\"https://vip.kontract360.com/\">\n"
                   "<id>%d</id>\n"
                  "<jobsitename>%@</jobsitename>\n"
                   "</UpdateJobSites>\n"
                   "</soap:Body>\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/UpdateJobSites" forHTTPHeaderField:@"Soapaction"];
...
-(void)SearchJobSite
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SearchJobSite xmlns=\"https://vip.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/SearchJobSite" forHTTPHeaderField:@"Soapaction"];
