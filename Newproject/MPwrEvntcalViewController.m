...
-(void)ManpowerCalenderDaySelect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<ManpowerCalenderDaySelect xmlns=\"https://vip.kontract360.com/\">\n"
                   "<LeadID>%d</LeadID>\n"
                   "<start>%@</start>\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/ManpowerCalenderDaySelect" forHTTPHeaderField:@"Soapaction"];
