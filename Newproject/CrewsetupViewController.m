...
-(void)CrewManPowerSelect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<CrewManPowerSelect xmlns=\"https://testUSA.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/CrewManPowerSelect" forHTTPHeaderField:@"Soapaction"];
...
-(void)CrewSave{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<CrewSave xmlns=\"https://testUSA.kontract360.com/\">\n"
                    "<CrewName>%@</CrewName>\n"
                   "</CrewSave>\n"
                   "</soap:Body>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/CrewSave" forHTTPHeaderField:@"Soapaction"];
...
-(void)CrewSetUpSelect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<CrewSetUpSelect xmlns=\"https://testUSA.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/CrewSetUpSelect" forHTTPHeaderField:@"Soapaction"];
...
-(void)Selectcrewname{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<Selectcrewname xmlns=\"https://testUSA.kontract360.com/\">\n"
                    "<crewname>%@</crewname>\n"
                   "</Selectcrewname>\n"
                   "</soap:Body>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/Selectcrewname" forHTTPHeaderField:@"Soapaction"];
...
-(void)crewinsert{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<crewinsert xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<Manpower>%@</Manpower>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/crewinsert" forHTTPHeaderField:@"Soapaction"];
...
-(void)Crewdelete{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<Crewdelete xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<ID>%d</ID>\n"
                   "</Crewdelete>\n"
                   "</soap:Body>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/Crewdelete" forHTTPHeaderField:@"Soapaction"];
...
-(void)CrewSetUpDelete{
  ...
  //  Crewmodel *crewmdl1=(Crewmodel *)[_crewmembersarray objectAtIndex:path];
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<CrewSetUpDelete xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<CrewId>%d</CrewId>\n"
                   "</CrewSetUpDelete>\n"
                   "</soap:Body>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/CrewSetUpDelete" forHTTPHeaderField:@"Soapaction"];
...
-(void)AllCrewDelete{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<AllCrewDelete xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<CrewId>%d</CrewId>\n"
                   "</AllCrewDelete>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",[[_crewdict objectForKey:_crewbtnlbl.titleLabel.text]integerValue ]];
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/AllCrewDelete" forHTTPHeaderField:@"Soapaction"];
...
-(void)UserLogmaininsert{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "</UserLogmaininsert>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",curntdate,[userid integerValue],31,@"Create",@"iOS",extnalip,intrnalip,Udid];
    NSLog(@"soapmsg%@",soapMessage);
...
-(void)UserLogcrewMove{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "</UserLogmaininsert>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",curntdate,[userid integerValue],31,@"Move",@"iOS",extnalip,intrnalip,Udid];
    NSLog(@"soapmsg%@",soapMessage);
...
-(void)UserLogcrewNamedelete{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "</UserLogmaininsert>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",curntdate,[userid integerValue],31,@"Crewname Delete",@"iOS",extnalip,intrnalip,Udid];
    NSLog(@"soapmsg%@",soapMessage);
...
-(void)UserLogcrewdelete{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "</UserLogmaininsert>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",curntdate,[userid integerValue],31,@"Crew Delete",@"iOS",extnalip,intrnalip,Udid];
    NSLog(@"soapmsg%@",soapMessage);
...
-(void)UserLogcrewitemdelete{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "</UserLogmaininsert>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",curntdate,[userid integerValue],31,@"CrewItems Delete",@"iOS",extnalip,intrnalip,Udid];
    NSLog(@"soapmsg%@",soapMessage);
...
- (IBAction)clearbtn:(id)sender {
    ...
    if([_crewbtnlbl.titleLabel.text isEqualToString:@"Select"]){
        ...
        UIAlertView*alert=[[UIAlertView alloc]initWithTitle:@"" message:@"Please select crew" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
        [alert show];
