...
-(void)AccebilityUploadPlanDrawings{
   ...
   //  NSString *filename =[NSString stringWithFormat:@"Drawings/%@-%@-%@.jpg",plantrimmestrg,@"Accessibility",_savename];
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<UploadPlanDrawings xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<f>%@</f>\n"
                   "<fileName>%@</fileName>\n"
                   "<PlanId>%@</PlanId>\n"
                   "<Location>%@</Location>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/UploadPlanDrawings" forHTTPHeaderField:@"Soapaction"];
