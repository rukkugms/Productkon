...
-(void)CrewMaterialselect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<CrewMaterialselect xmlns=\"https://testUSA.kontract360.com/\">\n"
   ...
   //   NSURL *url = [NSURL URLWithString:@"https://testusa.kontract360.com/service.asmx"];
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/CrewMaterialselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)CrewMaterialSave{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<CrewMaterialSave xmlns=\"https://testUSA.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/CrewMaterialSave" forHTTPHeaderField:@"Soapaction"];
...
-(void)MatrialCrewSetupSelect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<MatrialCrewSetupSelect xmlns=\"https://testUSA.kontract360.com/\">\n"
   ...
   //   NSURL *url = [NSURL URLWithString:@"https://testusa.kontract360.com/service.asmx"];
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/MatrialCrewSetupSelect" forHTTPHeaderField:@"Soapaction"];
...
-(void)MaterialCrewNameSelect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<MaterialCrewNameSelect xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<CrewId>%d</CrewId>\n"
   ...
   //   NSURL *url = [NSURL URLWithString:@"https://testusa.kontract360.com/service.asmx"];
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/MaterialCrewNameSelect" forHTTPHeaderField:@"Soapaction"];
...
-(void)MaterialCrewSetUpDelete{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<MaterialCrewSetUpDelete xmlns=\"https://testUSA.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/MaterialCrewSetUpDelete" forHTTPHeaderField:@"Soapaction"];
...
-(void)MaterialCrewInsert
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<MaterialCrewInsert xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<Material>%@</Material>\n"
   ...
   //   NSURL *url = [NSURL URLWithString:@"https://testusa.kontract360.com/service.asmx"];
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/MaterialCrewInsert" forHTTPHeaderField:@"Soapaction"];
...
-(void)MaterialCrewdelete{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<MaterialCrewdelete xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<ID>%d</ID>\n"
                   "</MaterialCrewdelete>\n"
                   "</soap:Body>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/MaterialCrewdelete" forHTTPHeaderField:@"Soapaction"];
...
-(void)AllMaterialCrewDelete{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<AllMaterialCrewDelete xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<CrewId>%d</CrewId>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/AllMaterialCrewDelete" forHTTPHeaderField:@"Soapaction"];
