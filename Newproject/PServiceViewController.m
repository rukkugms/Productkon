...
-(void)Workentryserviceselect{
   // _planID=@"Pl-00001";
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<Workentryserviceselect xmlns=\"http://test.kontract360.com/\">\n"
                   "<planid>%@</planid>\n"
   ...
   NSURL *url = [NSURL URLWithString:@"http://test.kontract360.com/service.asmx"];
    ...
    [theRequest addValue: @"http://test.kontract360.com/Workentryserviceselect" forHTTPHeaderField:@"Soapaction"];
