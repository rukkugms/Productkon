...
-(void)Workentryserviceselect{
   // _planID=@"Pl-00001";
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<Workentryserviceselect xmlns=\"https://vip.kontract360.com/\">\n"
                   "<planid>%@</planid>\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/Workentryserviceselect" forHTTPHeaderField:@"Soapaction"];
