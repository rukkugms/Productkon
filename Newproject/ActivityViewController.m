...
-(void)getLeadActivity
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<soap:Body>\n"
                    "<GetLeadActivity xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<Id>%d</Id>\n"
                   "</GetLeadActivity>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",_leadid];
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/GetLeadActivity" forHTTPHeaderField:@"Soapaction"];
...
-(void)getcomments
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<ActivityCommentsList xmlns=\"https://testUSA.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/ActivityCommentsList" forHTTPHeaderField:@"Soapaction"];
...
-(void)saveActivity
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">\n"
                   "<soap:Body>\n"
                   "<SaveActivity xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<LeadId>%d</LeadId>\n"
                   "<Date>%@</Date>\n"
                   "<Activity>%@</Activity>\n"
                   "<Employer>%d</Employer>\n"
    ...
    [theRequest addValue:@"https://testUSA.kontract360.com/SaveActivity" forHTTPHeaderField:@"Soapaction"];
...
{ webtype=1;
 ...
 NSString *idvalue=[_empdict objectForKey:[newarray objectAtIndex:1]];
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">\n"
                   "<soap:Body>\n"
                   "<UpdateLeadActivity xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<ActivityId>%d</ActivityId>\n"
                   "<LeadId>%d</LeadId>\n"
                   "<Date>%@</Date>\n"
                   "<Activity>%@</Activity>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/UpdateLeadActivity" forHTTPHeaderField:@"Soapaction"];
...
-(void)deleteActivity
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">\n"
                   "<soap:Body>\n"
                    "<DeleteActivity xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<activityid>%d</activityid>\n"
                   "</DeleteActivity>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",info2.activityId];
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/DeleteActivity" forHTTPHeaderField:@"Soapaction"];
...
-(void)saveComment
{
    ...
    activityInfo*info=(activityInfo*)[_activityArray objectAtIndex:btnindex];
       ...
       soapMessage = [NSString stringWithFormat:
                   ...
                   "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">\n"
                   "<soap:Body>\n"
                   "<SaveActivityComment xmlns=\"https://testUSA.kontract360.com/\">\n"
                      "<ActivityId>%d</ActivityId>\n"
                      "<Comments>%@</Comments>\n"
                      "<UserId>%d</UserId>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/SaveActivityComment" forHTTPHeaderField:@"Soapaction"];
...
-(void)SearchLeadActivity{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SearchLeadActivity xmlns=\"https://testUSA.kontract360.com/\">\n"
    ...
    [theRequest addValue:@"https://testUSA.kontract360.com/SearchLeadActivity" forHTTPHeaderField:@"Soapaction"];
