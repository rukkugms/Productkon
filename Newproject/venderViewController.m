...
- (void)viewDidLoad
{
    ...
    _venderaddview.backgroundColor=[UIColor colorWithRed:234.0/255.0f green:226/255.0f blue:226/255.0f alpha:1.0f];
...
-(IBAction)updatevender:(id)sender
{
    ...
    int value1=[val isBlank:[_nametextfld.text stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceCharacterSet]]];
        int value2=[val isBlank:[_addresstextfld.text stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceCharacterSet]]];
        if(value1==0)
        {
        ...
        {
            UIAlertView *alert1=[[UIAlertView alloc]initWithTitle:@"" message:@"Address is required" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
            [alert1 show];
        }
...
-(void)Selectvendor
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<Selectvendor xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<ItemId>%d</ItemId>\n"
                   "</Selectvendor>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",_itemid];
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/Selectvendor" forHTTPHeaderField:@"Soapaction"];
...
{  webtype=1;
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<VendorInsert xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<ItemId>%d</ItemId>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/VendorInsert" forHTTPHeaderField:@"Soapaction"];
...
{  webtype=1;
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<UpdateVendor xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<EntryId>%d</EntryId>\n"
                   "<ItemId>%d</ItemId>\n"
                   "<VendorName>%@</VendorName>\n"
                   "<VendorAddress>%@</VendorAddress>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/UpdateVendor" forHTTPHeaderField:@"Soapaction"];
...
{    webtype=2;
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<Vendordelete xmlns=\"https://testUSA.kontract360.com/\">\n"
                    "<EntryId>%d</EntryId>\n"
                   "<ItemId>%d</ItemId>\n"
                   "</Vendordelete>\n"
                   "</soap:Body>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/Vendordelete" forHTTPHeaderField:@"Soapaction"];
        ...
        if (textField==_phonetextfld)
            
            {
                ...
                else
                {
                    ...
                    if(value1==0)
                    {
                        UIAlertView*alert1=[[UIAlertView alloc]initWithTitle:@"" message:@"Invalid Phone Number" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil , nil];
                        [alert1 show];
