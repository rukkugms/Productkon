...
- (IBAction)updatebtn:(id)sender {
    ...
    else if ([_statebutton.titleLabel.text isEqualToString:@"Select"]||[_statebutton.titleLabel.text isEqualToString:@""])
    {
        ...
        {
            UIAlertView *alert=[[UIAlertView alloc]initWithTitle:nil message:@"Type of Lead is required" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
            [alert show];
        }
...
-(void)getLeads{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<GetLeads xmlns=\"http://test.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/GetLeads" forHTTPHeaderField:@"Soapaction"];
...
-(void)updatelead{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<UpdateCLMDemo xmlns=\"http://test.kontract360.com/\">\n"
  ...
  NSURL *url = [NSURL URLWithString:@"http://test.kontract360.com/service.asmx"];
    ...
    [theRequest addValue: @"http://test.kontract360.com/UpdateCLMDemo" forHTTPHeaderField:@"Soapaction"];
...
-(void)Addlead{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SaveLead xmlns=\"http://test.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/SaveLead" forHTTPHeaderField:@"Soapaction"];
...
-(void)SearchLead{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SearchLead1 xmlns=\"http://test.kontract360.com/\">\n"
    ...
    [theRequest addValue:@"http://test.kontract360.com/SearchLead1" forHTTPHeaderField:@"Soapaction"];
...
-(void)DeleteLead{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<DeleteLead xmlns=\"http://test.kontract360.com/\">\n"
                   "<leadid>%d</leadid>\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/DeleteLead" forHTTPHeaderField:@"Soapaction"];
...
-(void)LeadCommentsList{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<LeadCommentsList xmlns=\"http://test.kontract360.com/\">\n"
                   "<leadId>%d</leadId>\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/LeadCommentsList" forHTTPHeaderField:@"Soapaction"];
...
-(void)Saveleadcomment{
  ...
  //  NSTimeZone *timeZone = [NSTimeZone timeZoneWithName:@"Europe/London"];
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SaveLeadComment xmlns=\"http://test.kontract360.com/\">\n"
                   "<LeadId>%d</LeadId>\n"
                   "<Comments>%@</Comments>\n"
                   "<UserId>%d</UserId>\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/SaveLeadComment" forHTTPHeaderField:@"Soapaction"];
...
-(void)IndustrytypeSelect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<IndustrytypeSelect xmlns=\"http://test.kontract360.com/\">\n"
                   "</IndustrytypeSelect>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n"];
    NSLog(@"soapmsg%@",soapMessage);
   ...
   NSURL *url = [NSURL URLWithString:@"http://test.kontract360.com/service.asmx"];
    ...
    [theRequest addValue: @"http://test.kontract360.com/IndustrytypeSelect" forHTTPHeaderField:@"Soapaction"];
...
-(void)TypeofLeadSelect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<TypeofLeadSelect xmlns=\"http://test.kontract360.com/\">\n"
                   "</TypeofLeadSelect>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n"];
    NSLog(@"soapmsg%@",soapMessage);
    ...
    [theRequest addValue: @"http://test.kontract360.com/TypeofLeadSelect" forHTTPHeaderField:@"Soapaction"];
...
-(void)ProjecttypeSelect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<ProjecttypeSelect xmlns=\"http://test.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/ProjecttypeSelect" forHTTPHeaderField:@"Soapaction"];
...
- (void)textFieldDidEndEditing:(UITextField *)textField
{
    ...
    if(textField==_contactnametxtfld){
        ...
        if(value1==0)
        {
            ...
            UIAlertView *alert1=[[UIAlertView alloc]initWithTitle:nil message:@"Invalid Contact Name" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
            [alert1 show];
    ...
    if(textField==_citytxtfld){
        ...
        if(value1==0)
        {
            ...
            UIAlertView *alert1=[[UIAlertView alloc]initWithTitle:nil message:@"Invalid City" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
            [alert1 show];
    ...
    if(textField==_contacttiletxtfld){
        ...
        if(value1==0)
        {
            ...
            UIAlertView *alert1=[[UIAlertView alloc]initWithTitle:nil message:@"Invalid Contact Title" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
            [alert1 show];
