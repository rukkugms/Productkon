...
-(void)IndustryTypeInsert{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<IndustryTypeInsert xmlns=\"https://vip.kontract360.com/\">\n"
                   "<ITName>%@</ITName>\n"
                   "</IndustryTypeInsert>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",_industrytextfld.text];
  ...
  //    NSURL *url = [NSURL URLWithString:@"http://192.168.0.1/service.asmx"];
    ...
    [theRequest addValue: @"https://vip.kontract360.com/IndustryTypeInsert" forHTTPHeaderField:@"Soapaction"];
...
-(void)IndustrytypeUpdate{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<IndustrytypeUpdate xmlns=\"https://vip.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/IndustrytypeUpdate" forHTTPHeaderField:@"Soapaction"];
...
-(void)IndustryTypeDelete{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<IndustryTypeDelete xmlns=\"https://vip.kontract360.com/\">\n"
                   "<ITEntryId>%d</ITEntryId>\n"
                   "</IndustryTypeDelete>\n"
                   "</soap:Body>\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/IndustryTypeDelete" forHTTPHeaderField:@"Soapaction"];
