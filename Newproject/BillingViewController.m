...
- (void)viewDidLoad
{
 ...
 self.titleview.backgroundColor=[UIColor colorWithRed:234.0/255.0f green:244.0/255.0f blue:251.0/255.0f alpha:1.0f];
...
-(void)TotalMarkupselect
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<TotalMarkupselect xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<MarkupID>%d</MarkupID>\n"
                   "</TotalMarkupselect>\n"
                   "</soap:Body>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/TotalMarkupselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)BillingMatrixselect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<BillingMatrixselect xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<Id>%d</Id>\n"
                   "<MarkUp>%d</MarkUp>\n"
                   "</BillingMatrixselect>\n"
                   "</soap:Body>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/BillingMatrixselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)BillingMatrix1select{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<soap:Body>\n"
                    ...
                    "<BillingMatrix1select xmlns=\"https://testUSA.kontract360.com/\">\n"
                    "<Id>%d</Id>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/BillingMatrix1select" forHTTPHeaderField:@"Soapaction"];
