...
-(void)TotalMarkupselect
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<TotalMarkupselect xmlns=\"http://test.kontract360.com/\">\n"
                   "<MarkupID>%d</MarkupID>\n"
                   "</TotalMarkupselect>\n"
                   "</soap:Body>\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/TotalMarkupselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)Selectallmanpower{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SelectAllManpower xmlns=\"http://test.kontract360.com/\">\n"
   ...
   // NSURL *url = [NSURL URLWithString:@"http://test.kontract360.com/service.asmx"];
    ...
    [theRequest addValue: @"http://test.kontract360.com/SelectAllManpower" forHTTPHeaderField:@"Soapaction"];
...
-(void)BillingMatrixselect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<BillingMatrixselect xmlns=\"http://test.kontract360.com/\">\n"
                   "<Id>%d</Id>\n"
                   "<MarkUp>%d</MarkUp>\n"
                   "</BillingMatrixselect>\n"
                   "</soap:Body>\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/BillingMatrixselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)BillingMatrix1select{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<soap:Body>\n"
                    ...
                    "<BillingMatrix1select xmlns=\"http://test.kontract360.com/\">\n"
                    "<Id>%d</Id>\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/BillingMatrix1select" forHTTPHeaderField:@"Soapaction"];
