...
-(void)WorkTypeInsert{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<WorkTypeInsert xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<WorkType>%@</WorkType>\n"
                   "</WorkTypeInsert>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",_typetxtfld.text];
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/WorkTypeInsert" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
...
-(void)WorkTypeupdate{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<WorkTypeupdate xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<ID>%d</ID>\n"
                   "<WorkType>%@</WorkType>\n"
                   "</WorkTypeupdate>\n"
                   "</soap:Body>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/WorkTypeupdate" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
...
-(void)WorkTypeDelete{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<WorkTypeDelete xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<ID>%d</ID>\n"
                   "</WorkTypeDelete>\n"
                   "</soap:Body>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/WorkTypeDelete" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
