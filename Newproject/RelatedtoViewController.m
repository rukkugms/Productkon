...
-(void)IMMRelationSelect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<IMMRelationSelect xmlns=\"https://vip.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/IMMRelationSelect" forHTTPHeaderField:@"Soapaction"];
...
-(void)IdSelect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<IdSelect xmlns=\"https://vip.kontract360.com/\">\n"
                   "<JobNumber>%@</JobNumber>\n"
                   "</IdSelect>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",_jobnumber];
    ...
    [theRequest addValue: @"https://vip.kontract360.com/IdSelect" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
...
-(void)IMManpowerSelect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<IMManpowerSelect xmlns=\"https://vip.kontract360.com/\">\n"
                   "<job_id>%@</job_id>\n"
                   "</IMManpowerSelect>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",_newid];
    ...
    [theRequest addValue: @"https://vip.kontract360.com/IMManpowerSelect" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
...
-(void)IMOthersSelect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<IMOthersSelect xmlns=\"https://vip.kontract360.com/\">\n"
                   "<Type>%@</Type>\n"
                   "<JobNumber>%@</JobNumber>\n"
                   "</IMOthersSelect>\n"
                   "</soap:Body>\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/IMOthersSelect" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
...
-(void)InsertIMMRelation{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<InsertIMMRelation xmlns=\"https://vip.kontract360.com/\">\n"
                   "<RTIssueManagementId>%@</RTIssueManagementId>\n"
                   "<RTValue>%d</RTValue>\n"
                   "<RTName>%@</RTName>\n"
                   "</InsertIMMRelation>\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/InsertIMMRelation" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
...
-(void)IMMRelationDelete{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<IMMRelationDelete xmlns=\"https://vip.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/IMMRelationDelete" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
