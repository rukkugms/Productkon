...
-(void)CreatePO{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<CreatePO xmlns=\"https://vip.kontract360.com/\">\n"
                   "<po>%@</po>\n"
                   "<JobID>%d</JobID>\n"
                   "<PODate>%@</PODate>\n"
                   "</CreatePO>\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/CreatePO" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
...
-(void)UpdatePO{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<UpdatePO xmlns=\"https://vip.kontract360.com/\">\n"
                   "<purchID>%d</purchID>\n"
                   "<po>%@</po>\n"
                   "<JobId>%d</JobId>\n"
                   "<podate>%@</podate>\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/UpdatePO" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
...
-(void)DestroyPO{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<DestroyPO xmlns=\"https://vip.kontract360.com/\">\n"
                   "<POId>%d</POId>\n"
                  "</DestroyPO>\n"
                   "</soap:Body>\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/DestroyPO" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
