...
-(void)InsertServices{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<InsertServices xmlns=\"https://vip.kontract360.com/\">\n"
                   "<servname>%@</servname>\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/InsertServices" forHTTPHeaderField:@"Soapaction"];
...
-(void)DeleteServices{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">\n"
                   "<soap:Body>\n"
                   "<DeleteServices xmlns=\"https://vip.kontract360.com/\">\n"
                    "<skillid>%d</skillid>\n"
                   "</DeleteServices>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",servmdl.servid];
    ...
    [theRequest addValue: @"https://vip.kontract360.com/DeleteServices" forHTTPHeaderField:@"Soapaction"];
...
-(void)UpdateServices{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<UpdateServices xmlns=\"https://vip.kontract360.com/\">\n"
                   "<SkillId>%d</SkillId>\n"
                   "<servname>%@</servname>\n"
                   "<Abbrevation>%@</Abbrevation>\n"
                   "</UpdateServices>\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/UpdateServices" forHTTPHeaderField:@"Soapaction"];
...
-(void)SearchServices{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SearchServices xmlns=\"https://vip.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/SearchServices" forHTTPHeaderField:@"Soapaction"];
