...
-(void)SelectAllSubtypeEquipment{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SelectAllSubtypeEquipment xmlns=\"https://testUSA.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/SelectAllSubtypeEquipment" forHTTPHeaderField:@"Soapaction"];
...
-(void)SelectAllEquipment{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SelectAllEquipment xmlns=\"https://testUSA.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/SelectAllEquipment" forHTTPHeaderField:@"Soapaction"];
  ...
  //  NSString*picturelocatn=@"";
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<soap:Body>\n"
                    ...
                    "<InsertEquipment xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<ItemCode>%@</ItemCode>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/InsertEquipment" forHTTPHeaderField:@"Soapaction"];
...
-(void)UpdateEquipment{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<UpdateEquipment xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<ItemCode>%@</ItemCode>\n"
                   "<Description>%@</Description>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/UpdateEquipment" forHTTPHeaderField:@"Soapaction"];
...
-(void)DeleteEquipment{
  ...
  Equpmntmdl*eqmdl=(Equpmntmdl *)[_Equpntarray objectAtIndex:deltepath];
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<DeleteEquipment xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<entryid>%d</entryid>\n"
                   "</DeleteEquipment>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",eqmdl.entryid];
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/DeleteEquipment" forHTTPHeaderField:@"Soapaction"];
...
-(void)SearchEquipment{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SearchEquipment xmlns=\"https://testUSA.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/SearchEquipment" forHTTPHeaderField:@"Soapaction"];
...
-(void)UserLogmaininsert{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "</UserLogmaininsert>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",curntdate,[useridname integerValue],27,@"Create",@"iOS",extnalip,intrnalip,Udid,0];
    NSLog(@"soapmsg%@",soapMessage);
...
-(void)UserLogmainupdate{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "</UserLogmaininsert>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",curntdate,[useridname integerValue],27,@"Edit",@"iOS",extnalip,intrnalip,Udid,0];
    NSLog(@"soapmsg%@",soapMessage);
...
-(void)UserLogmaindelete{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "</UserLogmaininsert>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",curntdate,[useridname integerValue],27,@"Delete",@"iOS",extnalip,intrnalip,Udid,0];
    NSLog(@"soapmsg%@",soapMessage);
       ...
       int value9=[val isNumeric:_weeklytxtfld.text];
        if (value9==0) {
           ...
           // float daily=8*hourly;
            //dailytxtfld.text=[NSString stringWithFormat:@"%g",daily];
            float monthly=72*hourly;
            _monthlytxtfld.text=[NSString stringWithFormat:@"%g",monthly];
