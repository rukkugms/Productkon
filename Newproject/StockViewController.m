...
-(void)StockOutInsert{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<StockOutInsert xmlns=\"https://vip.kontract360.com/\">\n"
                   "<MainId>%d</MainId>\n"
                   "<JobNumber>%@</JobNumber>\n"
                   "<JobSite>%@</JobSite>\n"
                   "<ItemCode>%@</ItemCode>\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/StockOutInsert" forHTTPHeaderField:@"Soapaction"];
...
-(void)SiteInInsert{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SiteInInsert xmlns=\"https://vip.kontract360.com/\">\n"
                   "<MainId>%d</MainId>\n"
                   "<JobNumber>%@</JobNumber>\n"
                   "<JobSite>%@</JobSite>\n"
                   "<ItemCode>%@</ItemCode>\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/SiteInInsert" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
...
-(void)StockInInsert{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<StockInInsert xmlns=\"https://vip.kontract360.com/\">\n"
                   "<MainId>%d</MainId>\n"
                   "<JobNumber>%@</JobNumber>\n"
                   "<JobSite>%@</JobSite>\n"
                   "<ItemCode>%@</ItemCode>\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/StockInInsert" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
...
-(void)StockInUpdate{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<StockInUpdate xmlns=\"https://vip.kontract360.com/\">\n"
                   "<MainId>%d</MainId>\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/StockInUpdate" forHTTPHeaderField:@"Soapaction"];
...
-(void)StockInSelect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<StockInSelect xmlns=\"https://vip.kontract360.com/\">\n"
                   "<MainId>%d</MainId>\n"
                   "</StockInSelect>\n"
                   "</soap:Body>\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/StockInSelect" forHTTPHeaderField:@"Soapaction"];
...
-(void)NotesStockInselect
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<NotesStockInselect xmlns=\"https://vip.kontract360.com/\">\n"
                   "<MainId>%d</MainId>\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/NotesStockInselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)StockInExceptionUpdate
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<StockInExceptionUpdate xmlns=\"https://vip.kontract360.com/\">\n"
                   "<MainId>%d</MainId>\n"
                   "<Notes>%@</Notes>\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/StockInExceptionUpdate" forHTTPHeaderField:@"Soapaction"];
