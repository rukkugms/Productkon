...
-(void)Getbasicinfo{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<GetBasicInfo xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "</GetBasicInfo>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n"];
   ...
   //   NSURL *url = [NSURL URLWithString:@"https://testusa.kontract360.com/service.asmx"];
    ...
    [theRequest addValue: @"text/xml; charset=utf-8" forHTTPHeaderField:@"Content-Type"];
     ...
     [theRequest addValue: @"https://testUSA.kontract360.com/GetBasicInfo" forHTTPHeaderField:@"Soapaction"];
...
-(void)SaveBasicInfo{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SaveBasicInfo xmlns=\"https://testUSA.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/SaveBasicInfo" forHTTPHeaderField:@"Soapaction"];
...
-(void)parser:(NSXMLParser *)parser didEndElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName
{
    ...
    if([elementName isEqualToString:@"LetterHead"])
    {
        ...
        recordResults = FALSE;
        NSString *fullURL =[NSString stringWithFormat:@"https://testUSA.kontract360.com/Files/Docs/BasicInfo/%@",_soapResults]  ;
