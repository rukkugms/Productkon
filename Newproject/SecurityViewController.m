...
- (void)viewDidLoad
{
    ...
    _view1.layer.borderColor=[UIColor blackColor].CGColor;
      [[self.view1 layer] setCornerRadius:10];
    //[UIColor colorWithRed:234.0/255.0f green:244.0/255.0f blue:250.0/255.0f alpha:1.0f].CGColor;
...
-(void)createpopover{
    ...
    _popOverTableView=[[UITableView alloc]initWithFrame:CGRectMake(0, 0, 400, 200)];
    ...
    popoverContent.contentSizeForViewInPopover = CGSizeMake(400, 200);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text=[_qustnarray objectAtIndex:indexPath.row];
...
-(void)SecurityQuestionSelect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SecurityQuestionSelect xmlns=\"https://testUSA.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/SecurityQuestionSelect" forHTTPHeaderField:@"Soapaction"];
...
-(void)SecurityAnswersInsert{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SecurityAnswersInsert xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<userid>%d</userid>\n"
                   "<qid>%d</qid>\n"
                   "<answer>%@</answer>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/SecurityAnswersInsert" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
...
-(void)Getanswer{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<Getanswer xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<userid>%d</userid>\n"
                   "<qid>%d</qid>\n"
                   "</Getanswer>\n"
                   "</soap:Body>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/Getanswer" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
...
-(void)SecurityquestionandanswersDelete{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SecurityquestionandanswersDelete xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<userid>%d</userid>\n"
                   "<qid>%d</qid>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/SecurityquestionandanswersDelete" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
...
-(void)QuestioncountSelect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<QuestioncountSelect xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<userid>%d</userid>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/QuestioncountSelect" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
...
-(void)parser:(NSXMLParser *)parser didStartElement:(NSString *)elementName namespaceURI:(NSString *) namespaceURI qualifiedName:(NSString *)qName
   attributes: (NSDictionary *)attributeDict{
    if([elementName isEqualToString:@"SecurityQuestionSelectResponse"])
    {
        _qustndict=[[NSMutableDictionary alloc]init];
        _qustnarray=[[NSMutableArray alloc]init];
        if(!_soapResults)
        {
...
-(void)parser:(NSXMLParser *)parser didEndElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName
{
    ...
    if([elementName isEqualToString:@"question"])
    {
        ...
        recordResults = FALSE;
        [_qustndict setObject:entryid forKey:_soapResults];
        [_qustnarray addObject:_soapResults];
...
- (BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string{
    ...
    if(textField==_answertxtfld)
    {
        NSUInteger newLength = [_answertxtfld.text length] + [string length] - range.length;
