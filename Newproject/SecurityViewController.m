...
-(void)SecurityQuestionSelect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SecurityQuestionSelect xmlns=\"https://vip.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/SecurityQuestionSelect" forHTTPHeaderField:@"Soapaction"];
...
-(void)SecurityAnswersInsert{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SecurityAnswersInsert xmlns=\"https://vip.kontract360.com/\">\n"
                   "<userid>%d</userid>\n"
                   "<qid>%d</qid>\n"
                   "<answer>%@</answer>\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/SecurityAnswersInsert" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
...
-(void)Getanswer{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<Getanswer xmlns=\"https://vip.kontract360.com/\">\n"
                   "<userid>%d</userid>\n"
                   "<qid>%d</qid>\n"
                   "</Getanswer>\n"
                   "</soap:Body>\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/Getanswer" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
...
-(void)SecurityquestionandanswersDelete{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SecurityquestionandanswersDelete xmlns=\"https://vip.kontract360.com/\">\n"
                   "<userid>%d</userid>\n"
                   "<qid>%d</qid>\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/SecurityquestionandanswersDelete" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
...
-(void)QuestioncountSelect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<QuestioncountSelect xmlns=\"https://vip.kontract360.com/\">\n"
                   "<userid>%d</userid>\n"
    ...
    [theRequest addValue: @"https://vip.kontract360.com/QuestioncountSelect" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
