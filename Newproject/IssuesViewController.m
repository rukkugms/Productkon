...
-(void)IssueManagementSelect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<IssueManagementSelect xmlns=\"https://testUSA.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/IssueManagementSelect" forHTTPHeaderField:@"Soapaction"];
...
//  
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<IssueManagementInsert xmlns=\"https://testUSA.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/IssueManagementInsert" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
...
-(void)IssueManagementUpdate{
   ...
   // NSString*jobno=[NSString stringWithFormat:@"%@-%@",[array objectAtIndex:0],[array objectAtIndex:1]];
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<IssueManagementUpdate xmlns=\"https://testUSA.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/IssueManagementUpdate" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
...
-(void)IssueManagementSearch{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<IssueManagementSearch xmlns=\"https://testUSA.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/IssueManagementSearch" forHTTPHeaderField:@"Soapaction"];
...
-(void)IssueManagementcommentselect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<IssueManagementcommentselect xmlns=\"https://testUSA.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/IssueManagementcommentselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)IssueManagementCommentsInsert{
   ...
   // NSString*usernameid = [defaults objectForKey:@"UserNameId"];
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<IssueManagementCommentsInsert xmlns=\"https://testUSA.kontract360.com/\">\n"
                   "<IMMItemCode>%@</IMMItemCode>\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/IssueManagementCommentsInsert" forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
...
-(void)IssueRelationFlag{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<IssueRelationFlag xmlns=\"https://testUSA.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"https://testUSA.kontract360.com/IssueRelationFlag" forHTTPHeaderField:@"Soapaction"];
