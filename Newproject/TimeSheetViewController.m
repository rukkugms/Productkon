...
-(void)TimesheetServiceselect{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<TimesheetServiceselect xmlns=\"http://test.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/TimesheetServiceselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)TimeSheetPhasesSelect
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<TimeSheetPhasesSelect xmlns=\"http://test.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/TimeSheetPhasesSelect" forHTTPHeaderField:@"Soapaction"];
...
-(void)TimeSheetSequenceSelect
{
  ...
  //  NSString *job=[NSString stringWithFormat:@"%@",[_jobdict objectForKey:jobno]];
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<TimeSheetSequenceSelect xmlns=\"http://test.kontract360.com/\">\n"
                   "<jobid>%@</jobid>\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/TimeSheetSequenceSelect" forHTTPHeaderField:@"Soapaction"];
...
-(void)TimeSheetSequenceGeneralSelect
{
  ...
  //  NSString *job=[NSString stringWithFormat:@"%@",[_jobdict objectForKey:jobno]];
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<TimeSheetSequenceGeneralSelect xmlns=\"http://test.kontract360.com/\">\n"
                   "<jobid>%@</jobid>\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/TimeSheetSequenceGeneralSelect" forHTTPHeaderField:@"Soapaction"];
...
-(void)PurchaseOrderselect
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<PurchaseOrderselect xmlns=\"http://test.kontract360.com/\">\n"
                   "<JobId>%@</JobId>\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/PurchaseOrderselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)WorkOrderselect
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<WorkOrderselect xmlns=\"http://test.kontract360.com/\">\n"
                   "<JobId>%@</JobId>\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/WorkOrderselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)TimesheetLaborselect
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<TimesheetLaborselect xmlns=\"http://test.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/TimesheetLaborselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)TimesheetEquipmentselect
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<TimesheetEquipmentselect xmlns=\"http://test.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/TimesheetEquipmentselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)TimesheetFleetselect
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<TimesheetFleetselect xmlns=\"http://test.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/TimesheetFleetselect" forHTTPHeaderField:@"Soapaction"];
...
-(void)TimesheetMaterialselect
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<TimesheetMaterialselect xmlns=\"http://test.kontract360.com/\">\n"
    ...
    [theRequest addValue: @"http://test.kontract360.com/TimesheetMaterialselect" forHTTPHeaderField:@"Soapaction"];
